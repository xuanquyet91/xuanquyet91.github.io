...
const TagsAdmin = () => {
  ...
  const handleDelete = (id) => {
    axios
      .delete(`https://624bab2444505084bc54160d.mockapi.io/tag/${id}`)
      .then(async () => {
  ...
  const onSubmit = (event) => {
    ...
    if (typeForm == 1) {
      ...
      axios
        .put(
          `https://624bab2444505084bc54160d.mockapi.io/tag/${updateID}`,
          formUpdate
        )
        .then(async () => {
      ...
      axios
        .post(`https://624bab2444505084bc54160d.mockapi.io/tag`, formCreate)
        .then(async (response) => {
