        ...
        <div className="watchMovie__play">
          <div className="watchMovie__play__top">
            <div className="watchMovie__play__top-Title">
              <p className="title">
                Click quảng cáo là góp phần giúp phát triển PhimTopZ.Com. Tắt
                chặn quảng cáo để xem được Phim Nhé Các Bạn!
              </p>
            </div>
            <div className="watchMovie__play__top-Note">
              <p className="note">
                NẾU PHIM LOAD CHẬM, TẢI NGAY ỨNG DỤNG VPN (1.1.1.1) TẠI ĐÂY ĐỂ
                CẢI THIỆN TỐC ĐỘ
              </p>
            </div>
          </div>
          <iframe width="1020" height="600" title="Watch Video" src={source} />
