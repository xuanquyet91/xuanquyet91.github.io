    ...
    <div className="product">
      <div className="product__content">
        ...
        <div className="product__content__right">
          ...
          <p>
            Channel:<span>{productItem?.channel}</span>
          </p>
          <p>
            Director: <span>{productItem?.directors}</span>
          </p>
          <p>
            Actor: <span>{productItem?.actor}</span>
          </p>
          <p>
            Type: <span>{productItem?.type}</span>
          </p>
          <p>
            Nation: <span>{productItem?.nation}</span>
          </p>
          <p>
            Time: <span>{productItem?.time}</span>
          </p>
          <p>
            View: <span>{productItem?.view}</span>{" "}
          </p>
          <p>
            Year: <span> {productItem?.year}</span>
          </p>
